...
Current systems features include readable bitwise operators, fixed-width integers (`u8` through `u64`, `i8` through `i64`), mutable indexes, compact byte memory, typed integer arrays, and zero-copy mutable slices. See [`docs/pt-BR/inteiros-de-tamanho-fixo.md`](./docs/pt-BR/inteiros-de-tamanho-fixo.md), [`docs/pt-BR/mutacao-por-indice.md`](./docs/pt-BR/mutacao-por-indice.md), and [`docs/pt-BR/memoria-compacta.md`](./docs/pt-BR/memoria-compacta.md).
