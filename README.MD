...
**Zumbra 0.12.5** completa a edição de texto dos inputs e textareas com caret, seleção, navegação por teclado e mouse e clipboard; também adiciona gutter dedicado para scrollbars, recorte proporcional de imagens com `fit: "cover"` e padroniza em inglês as mensagens padrão do runtime e da CLI. Consulte [`docs/releases/0.12.5.md`](./docs/releases/0.12.5.md).
