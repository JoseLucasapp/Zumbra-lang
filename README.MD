...
**Zumbra 0.12.4** corrige o preenchimento vertical de navegações laterais e adiciona rótulos e valores aos gráficos de linha. Consulte [`docs/releases/0.12.4.md`](./docs/releases/0.12.4.md).
...
Navegações laterais agora preservam toda a altura disponível. Gráficos de linha mostram valores e rótulos categóricos nos backends SDL3 Go/cgo e C11. Veja [`docs/releases/0.12.4.md`](./docs/releases/0.12.4.md).
