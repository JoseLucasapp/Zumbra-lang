...
Current systems features include readable bitwise operators, fixed-width integers (`u8` through `u64`, `i8` through `i64`), and mutable array/dictionary indexes. See [`docs/pt-BR/inteiros-de-tamanho-fixo.md`](./docs/pt-BR/inteiros-de-tamanho-fixo.md) and [`docs/pt-BR/mutacao-por-indice.md`](./docs/pt-BR/mutacao-por-indice.md).
