...
Current systems features include readable bitwise operators and fixed-width integers (`u8` through `u64`, `i8` through `i64`). See [`docs/pt-BR/inteiros-de-tamanho-fixo.md`](./docs/pt-BR/inteiros-de-tamanho-fixo.md).
