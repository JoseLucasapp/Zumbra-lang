...
**Zumbra 0.12.3** finaliza o acabamento visual do Z16 com cursores `pointer`/`text`, caret real em inputs, ícones vetoriais para botões, foco sem clipping, scrollbar overlay sem perda de largura e reflow completo de navegações ocultas. Consulte [`docs/releases/0.12.3.md`](./docs/releases/0.12.3.md).
