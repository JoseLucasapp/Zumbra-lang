...
func init() {
	...
	mysql := []string{
		"mysqlConnection", "mysqlCreateTable", "mysqlDeleteFromTable", "mysqlGetFromTable", "mysqlInsertIntoTable", "mysqlShowTables", "mysqlShowTableColumns", "mysqlUpdateIntoTable",
	}
