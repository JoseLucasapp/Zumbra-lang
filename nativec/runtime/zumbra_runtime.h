...
typedef enum {
    ...
    ZK_SQLITE_DATABASE,
    ZK_SQLITE_STATEMENT,
    ZK_SQLITE_TRANSACTION,
    ZK_SQL_ROWS,
    ZK_POSTGRES_DATABASE,
    ZK_POSTGRES_STATEMENT,
    ZK_POSTGRES_TRANSACTION,
    ZK_REDIS_CLIENT,
    ZK_CONFIG,
    ZK_LOGGER,
    ZK_METRICS,
...
typedef enum {
    ...
    ZV_SQLITE_DATABASE,
    ZV_SQLITE_STATEMENT,
    ZV_SQLITE_TRANSACTION,
    ZV_SQLITE_METHOD,
    ZV_SQL_ROWS,
    ZV_POSTGRES_DATABASE,
    ZV_POSTGRES_STATEMENT,
    ZV_POSTGRES_TRANSACTION,
    ZV_REDIS_CLIENT,
    ZV_CONFIG,
    ZV_LOGGER,
    ZV_METRICS,
